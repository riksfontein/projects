CH03EP10_B - Omni Flash chain, clips 1-12 (2 min 0 s)

1. FIRST FRAME  (made by Claude, not in TurboFlow - nothing to generate here)
   ch03\samples_2min\B_start.png
   Made by Claude on 2026-09-24 from CH03EP10_B_omni_first_frame.txt (prompt unchanged), variants
...
2. CHAIN
   ...
   Start frame: ch03\samples_2min\B_start.png (the master image Claude made and picked)
   ...
   Settings: Save folder ch03-samples . Auto-download videos . Video quality 1080p Upscale
             File naming custom prefix: ch03-B  sep _  start number 1
   Prompts: import CH03EP10_B_omni_clips_001-012.txt (12 prompts, each {...} block = 1 prompt)
   CHECK before Run: the Queue tab row shows the "continuous" tag. No tag = not chained.
   Output: Downloads\ch03-samples\ch03-B_001.mp4 ... ch03-B_012.mp4
