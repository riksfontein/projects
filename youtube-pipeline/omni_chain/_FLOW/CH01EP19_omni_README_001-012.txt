...
1. FIRST FRAME  (made by Claude, not in TurboFlow - nothing to generate here)
   _FLOW\first_frames\CH01EP19_first_frame.jpg
   Made by Claude at the highest image quality (4K, 16:9) from CH01EP19_omni_first_frame.txt, variants
...
2. CHAIN
   ...
   Start frame: _FLOW\first_frames\CH01EP19_first_frame.jpg (the master image Claude made and picked)
